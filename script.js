$(document).ready(function() {
  ...
  if (window.location.hash) {
    ...
    $('#new-page').show()
    client.add('magnet:?xt=urn:btih:' + document.URL.substr(document.URL.indexOf('#') + 1) + '&tr=wss%3A%2F%2Ftracker.btorrent.xyz&tr=wss%3A%2F%2Ftracker.fastcast.nz&tr=wss%3A%2F%2Ftracker.openwebtorrent.com', function (torrent) {
      swarm = torrent.swarm
